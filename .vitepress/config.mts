...
const DEFAULT_SOCIAL_IMAGE: SocialImage = {
	path: '/versatiles-social.png',
	type: 'image/png',
	alt: 'versatiles logo on a gradient background',
};

// Per-page social media preview images, keyed by page path.
// showcases-social.jpg is generated by scripts/build-social-image.ts.
const SOCIAL_IMAGES: Record<string, SocialImage> = {
	'showcases/index.md': {
		path: '/showcases-social.jpg',
		type: 'image/jpeg',
		alt: 'a wall of maps built with VersaTiles, with the versatiles logo in front',
	},
};
