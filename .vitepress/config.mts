...
export default withMermaid(
	defineConfig({
		...
		head: [
			...
			[
				'meta',
				{ property: 'og:image', content: 'https://docs.versatiles.org/versatiles-social.png' },
			],
			...
			[
				'meta',
				{ property: 'og:image:alt', content: 'versatiles logo on a gradient background' },
			],
		],
		ignoreDeadLinks: [
			/^https?:\/\/localhost/,
				...
				},
				{
					...
					items: [
						...
						},
						{
							...
							items: [
								{
									text: 'Generate Tiles from OSM',
									link: '/guides/generate_tiles_from_osm',
								},
			...
			socialLinks: [
				{
					...
					link: 'https://docs.versatiles.org',
					icon: {
						svg: '<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><path fill="currentColor" d="m12 3l8 6v12h-5v-7H9v7H4V9z"/></svg>',
					},
				},
				{
					ariaLabel: 'GitHub',
					link: 'https://github.com/versatiles-org',
					icon: {
