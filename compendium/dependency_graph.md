...
flowchart LR
  ...
  subgraph r_applications_g["Applications and tools"]
    direction LR
    r_editor["editor"]
  ...
  subgraph r_production_g["Tile and asset production"]
    direction LR
  ...
  subgraph r_operations_g["Packaging and operations"]
    direction LR
    r__github[".github"]
