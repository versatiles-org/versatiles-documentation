...
│   │   └── 📄 <a href="#file-tilestileset_idtilesjson">tiles.json</a>
...
The `/tiles/` folder is used to provide map tiles and associated metadata. All files are generated by the map server.
