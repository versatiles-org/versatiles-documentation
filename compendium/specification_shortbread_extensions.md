...
> This page documents the **schema contract** (what extra attributes/features exist and how to use them in a style). It is not the build manual — see the [profile README](https://github.com/versatiles-org/planetiler-shortbread/blob/main/README.md) for how tiles are generated.
...
The default is **`none`**. The token registry is defined in [`Experiment.java`](https://github.com/versatiles-org/planetiler-shortbread/blob/main/src/main/java/org/versatiles/shortbread/Experiment.java) and is the source of truth.
...
These (and smaller ones) follow from the profile implementation; the profile README documents further interpretation choices under [Notable output details](https://github.com/versatiles-org/planetiler-shortbread/blob/main/README.md#notable-output-details).
...
- VersaTiles profile: [`planetiler-shortbread`](https://github.com/versatiles-org/planetiler-shortbread) · [README](https://github.com/versatiles-org/planetiler-shortbread/blob/main/README.md) · [`Experiment.java`](https://github.com/versatiles-org/planetiler-shortbread/blob/main/src/main/java/org/versatiles/shortbread/Experiment.java)
...
- VersaTiles ecosystem: [versatiles-planetiler](../guides/generate_tiles_from_osm.md) (build) · [versatiles-style](https://github.com/versatiles-org/versatiles-style) (consumer)
